...
export function CuadrantesPanel() {
  ...
  // 🚨 CORRECCIÓN: Valores por defecto explícitos para evitar "Invalid time value" al montar el diálogo
  const assignForm = useForm<AssignFormValues>({
    resolver: zodResolver(assignSchema),
    defaultValues: {
      professionalIds: [],
      turnoId: '',
      // Inicialización con formato seguro para que new Date(string) sea válido
