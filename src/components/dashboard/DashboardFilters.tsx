...
          {/* ------------------ ESTATUS FUNCIONARIO (SINGLE SELECT) - CORREGIDO ------------------ */}
          <div className="space-y-2">
            <label className="text-sm font-medium text-gray-700">Estatus de Funcionario</label>
            <Select 
                value={typeof filters.estatus_funcionario === 'string' ? filters.estatus_funcionario : 'todos'} 
...
          {/* ------------------ CENTRO (SINGLE SELECT) - CORREGIDO ------------------ */}
          <div className="space-y-2">
            <label className="text-sm font-medium text-gray-700">Centro</label>
            <Select 
                value={typeof filters.centro_id === 'string' ? filters.centro_id : 'todos'} 
                onValueChange={(value) => {
