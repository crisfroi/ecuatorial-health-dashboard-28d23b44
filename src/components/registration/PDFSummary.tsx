...
// ELIMINA esta línea si ya no necesitas el componente BarcodeGenerator
          ...
          <div className="flex flex-col items-center space-y-2"> {/* Reducido space-y-3 a space-y-2 */}
            ...
            {formData.url_codigo_barras_expediente && ( // Usa la URL del código de barras
              <div className="flex flex-col items-center">
                ...
                />
                <p className="text-xs text-gray-600 text-center">Código de Barras Expediente</p>
              </div>
            )}
          </div>
...
export default PDFSummary; import React from 'react';
