        ...
        <CardContent>
          <div id="pdf-content" className="max-w-[210mm] mx-auto bg-white" style={{ padding: '5mm', fontSize: '10px', lineHeight: '1.2' }}>
            <div className="text-center border-b-2 border-black pb-4 mb-6">
              ...
              <h2 className="font-semibold text-gray-700" style={{ fontSize: '12px' }}></h2>
            ...
            <div className="flex gap-6 items-start">
              <div className="flex-1 space-y-3 pt-1.5">
                {/* Secciones de datos personales, profesionales, académicos, laborales */}
                {/* OMITIDO POR BREVEDAD - aquí van las secciones ya existentes */}
              </div>
